    ...
    <div class="container-fluid user-auth">
        <div class="hidden-xs col-sm-4 col-md-4 col-lg-4">
            ...
            <a class="logo" href="<?php echo URLROOT ?>">
                <img id="logo-user" class="img-responsive" src="<?php echo URLROOT ?>/images/logo-dark.png" alt="logo">
            </a>
            <!-- Logo Ends -->
            <!-- Slider Starts -->
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
            <!-- Logo Starts -->
            <a class="visible-xs" href="<?php echo URLROOT ?>">
                <img id="logo" class="img-responsive mobile-logo" src="<?php echo URLROOT ?>/images/logo-dark.png" alt="logo">
            </a>
            <!-- Logo Ends -->
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-6"><a href="<?php echo URLROOT ?>/pages/forget">I forgot my password</a></div>
                            </div>
                            <p class="text-center">don't have an account ? <a href="<?php echo URLROOT ?>/pages/register">register now</a>
                        </div>
